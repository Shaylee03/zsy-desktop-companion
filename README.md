...
- 把主动式 AI 的核心问题从“更频繁提醒”转成“控制主动介入边界”。
...
- 提供可下载的 Windows Starter Kit，让测试者可以在自己的电脑上启动本地 Agent，并连接自己的后端和机器人。
...
| 本地桌面 Agent starter | 已打包 | `downloads/zsy-desktop-agent-starter.zip` |
| 系统架构与策略 | 已文档化 | [系统架构](docs/architecture.md)、[决策流](docs/decision-flow.md) |
| 个性化记忆机制 | 已文档化 | [记忆进化机制](docs/memory-evolution.md) |
| 原型验证记录 | 已完成当前版本验证 | [验证记录](docs/validation.md)、[2026-06-26 验证结果](docs/validation-results-2026-06-26.md)、[证据地图](docs/evidence-map.md) |
